...
class ChengChurchAlgorithm(BaseBiclusteringAlgorithm):
    ...
    def run(self, data):
        ...
        # Creating Context and KeyGen in a Pyfhel Object
        HE = Pyfhel()
        ...
        # SeCCA - acceptable MSR threshold calculation
    ...
    def _calculate_msr(self, data, rows, cols):
        ...
        # SeCCA - MSR thr calculation for node deletion step
        HE = Pyfhel()
        HE.contextGen(p=65537, m=2048, flagBatching=True, base=2, intDigits=64, fracDigits=3)
        HE.keyGen()
    ...
    def _calculate_msr_col_addition(self, data, rows, cols):
        ...
        # SeCCA - MSR thr calculation for node column addition step
        HE = Pyfhel()
        HE.contextGen(p=65537, m=2048, flagBatching=True, base=2, intDigits=64, fracDigits=3)
        HE.keyGen()
        ...
        # Encrypting Squared Residues
        enc_col_squared_residues = enc_col_residues * enc_col_residues
    ...
    def _calculate_msr_row_addition(self, data, rows, cols):
        ...
        # Encrypting Squared Residues
        enc_row_squared_residues = enc_row_residues * enc_row_residues
